...
public class SegmentFlowAnalysisGroupingSet
		implements WritableComparable<SegmentFlowAnalysisGroupingSet> {
	...
	public SegmentFlowAnalysisGroupingSet(Text sd, IntWritable dc,
			IntWritable hfc, IntWritable mfc, IntWritable ffc, IntWritable sht,
			IntWritable eht, FloatWritable avgS, IntWritable ns, Text th,
			IntWritable r) {
		set(sd, dc, hfc, mfc, ffc, sht, eht, avgS, ns, th, r);
	}

	public SegmentFlowAnalysisGroupingSet(String sd, int dc, int hfc, int mfc,
			int ffc, int sht, int eht, float avgS, int ns, String th, int r) {
	...
	public SegmentFlowAnalysisGroupingSet() {
	...
	@Override
	public int compareTo(SegmentFlowAnalysisGroupingSet ssfa) {
