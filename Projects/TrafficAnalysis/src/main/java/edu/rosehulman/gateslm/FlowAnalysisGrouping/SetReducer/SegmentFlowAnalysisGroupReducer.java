...
public class SegmentFlowAnalysisGroupReducer
		extends Reducer<Text, SegmentFlowAnalysisGroupingSet, Text, Text> {

	public final int TOTAL_SECONDS_IN_DAY = 60 * 60 * 24;

	@Override
	protected void reduce(Text key,
			Iterable<SegmentFlowAnalysisGroupingSet> values, Context context)
		...
		for (SegmentFlowAnalysisGroupingSet value : values) {
			totalDays++;
