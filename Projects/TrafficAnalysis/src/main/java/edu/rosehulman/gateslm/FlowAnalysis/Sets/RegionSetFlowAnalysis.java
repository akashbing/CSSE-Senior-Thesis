...
public class RegionSetFlowAnalysis
		implements WritableComparable<RegionSetFlowAnalysis> {
	...
	public RegionSetFlowAnalysis(String d, int dc, int hfc, int mhfc, int mfc,
			int lfc, int ffc, int sht, int eht, float avgS, String th, int r) {
	...
	public RegionSetFlowAnalysis(Text d, IntWritable dc, IntWritable hfc,
			IntWritable mhfc, IntWritable mfc, IntWritable lfc, IntWritable ffc,
			IntWritable sht, IntWritable eht, FloatWritable avgS, Text th,
			IntWritable r) {
	...
	@Override
	public int compareTo(RegionSetFlowAnalysis rts) {
