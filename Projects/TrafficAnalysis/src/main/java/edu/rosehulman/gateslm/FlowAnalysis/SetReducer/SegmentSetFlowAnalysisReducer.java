...
public class SegmentSetFlowAnalysisReducer extends
		Reducer<IntWritable, SegmentSetFlowAnalysis, IntWritable, Text> {

	public final int TOTAL_SECONDS_IN_DAY = 60 * 60 * 24;

	@Override
	protected void reduce(IntWritable key,
			Iterable<SegmentSetFlowAnalysis> values, Context context)
		...
		for (SegmentSetFlowAnalysis value : values) {
			totalDays++;
